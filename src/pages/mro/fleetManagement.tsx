      ...
      <div className=' px-4'>
        ...
        <div className=' mx-auto mb-12 px-4'>
          <ul>
            ...
            <li className='list-disc'>
              Giving status of aircraft and Components complied AD, complied SB, LLP, Hard Time and
              OC/CM lists
            </li>
            <li className='list-disc'>
              Cabin and avionics modifications, engineering and implementation programs
        ...
        <h2 className='text-3xl font-bold mb-4'>Aircraft Maintenance Planning & Record Controls</h2>
        <div className=' mx-auto mb-12 px-4'>
          <ul>
            <li className='list-disc'>
