...
const Aviation = () => {
  ...
  const tabBodies = [
    ...
    <div className='grid grid-cols-1 lg:grid-cols-3 gap-3'>
      ...
      <div className='bg-gray-100 p-8 rounded-lg'>
        <p className='text-sm md:text-lg font-bold py-4'>National Aviation Sector Technical Advice</p>
        <p className='text-sm md:text-lg'>
      ...
      <div className='bg-gray-100 p-8 rounded-lg'>
        <p className='text-sm md:text-lg font-bold py-4'>Supporting Government Aircraft</p>
        <p className='text-sm md:text-lg'>
